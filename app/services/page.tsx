    ...
    {/* You can add more content here for the rest of your hero section */}
                ...
                <div className="relative">
                  ...
                  <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-lg shadow-lg max-w-xs">
                    <p className="text-gray-700 mb-2">
                      <span className="font-bold text-emerald-600">200+</span> Successful Projects
                    </p>
                    <p className="text-gray-700">
                      <span className="font-bold text-emerald-600">98%</span> Client Satisfaction
                    </p>
                  </div>
                </div>
              </div>
            ...
            <TabsContent value="homes" className="mt-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative">
                  ...
                  <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-lg shadow-lg max-w-xs">
                    <p className="text-gray-700 mb-2">
                      <span className="font-bold text-emerald-600">50+</span> Sustainable Buildings
                    </p>
                    <p className="text-gray-700">
                      <span className="font-bold text-emerald-600">30%</span> Energy Savings
                    </p>
                  </div>
                </div>
              </div>
            ...
            <TabsContent value="tours" className="mt-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative">
                  ...
                  <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-lg shadow-lg max-w-xs">
                    <p className="text-gray-700 mb-2">
                      <span className="font-bold text-emerald-600">100+</span> Destinations
                    </p>
                    <p className="text-gray-700">
                      <span className="font-bold text-emerald-600">10,000+</span> Happy Travelers
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="relative">
            {/* Process line */}
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 h-full w-1 bg-emerald-200 hidden md:block"></div>
            ...
            {[
              ...
              >
                <div
                  className="hidden md:block absolute top-0 w-10 h-10 rounded-full bg-emerald-500 text-white flex items-center justify-center font-bold border-4 border-white shadow-md"
                  style={{ [index % 2 === 0 ? "right" : "left"]: "-20px" }}
                >
                  {step.number}
                </div>
                <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                  <div className="md:hidden inline-block px-3 py-1 bg-emerald-500 text-white rounded-full font-bold mb-4">
                    {step.number}
                  </div>
