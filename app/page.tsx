...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Stats Section */}
      <section className="py-12 bg-gradient-to-r from-emerald-900 to-teal-800 text-white" ref={statsRef}>
              ...
              >
                <Card className="transition-all duration-500 hover:shadow-xl group border-none bg-gradient-to-br from-white to-gray-50 overflow-hidden h-full">
                  ...
                  <CardHeader className="text-center">
                    <motion.div
                      className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-emerald-200 transition-colors duration-300"
                  ...
                  <CardFooter className="flex justify-center">
                    <Button
                      variant="ghost"
                      className="text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 gap-2 group"
                    >
                      Learn More
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                {[
                  ...
                  >
                    <div className="mr-3 mt-1 bg-emerald-100 p-2 rounded-full">{item.icon}</div>
                    <div>
      ...
      <section className="py-20 bg-white overflow-hidden" ref={projectsRef}>
        <div className="container mx-auto px-4">
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 p-6 text-white">
                  <div className="inline-flex items-center bg-emerald-600/80 rounded-full px-3 py-1 text-xs font-medium mb-2">
                    {project.category}
                  </div>
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    className="text-white border-white hover:bg-white/20 transform translate-y-0 transition-transform duration-300 group-hover:-translate-y-1 transition-delay-100"
                  >
                    View Case Study
                  </Button>
                </div>
          ...
          >
            <Button asChild className="bg-emerald-600 hover:bg-emerald-700 group" size="lg">
              <Link href="/portfolio">
                View All Projects
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <motion.div
                className="bg-gradient-to-br from-emerald-50 to-teal-50 p-8 rounded-lg shadow-sm"
                whileHover={{ y: -5 }}
                transition={{ duration: 0.3 }}
              >
                <div className="mb-6">
                ...
                <Button
                  asChild
                  variant="outline"
                  className="text-emerald-700 border-emerald-700 hover:bg-emerald-50 group"
                >
                  <Link href="/about#csr">
                    Learn About Our CSR
                    <ArrowRight className="ml-2 h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-white text-emerald-800 hover:bg-gray-100 group">
                <Link href="/contact">
