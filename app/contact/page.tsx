    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="text-emerald-600 font-medium mb-2">info@company.com</p>
          <p className="text-gray-600 mb-1">Support:</p>
          <p className="text-emerald-600 font-medium">support@company.com</p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <p className="text-emerald-600 font-medium mb-2">+1 (555) 123-4567</p>
          <p className="text-gray-600 mb-1">Customer Service:</p>
          <p className="text-emerald-600 font-medium">+1 (555) 987-6543</p>
        </>
      ),
    },
  ]
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16" id="contact-form">
            ...
            >
              ...
              {isSubmitted ? (
                <motion.div
                  className="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-200 rounded-lg p-8 text-center"
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                size="lg"
                className="bg-white text-emerald-800 hover:bg-gray-100 group shadow-lg"
