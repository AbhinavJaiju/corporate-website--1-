    ...
    <footer className="bg-gradient-to-br from-gray-900 to-gray-950 text-white relative">
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-center">
          <motion.button
            onClick={scrollToTop}
            className="bg-emerald-600 hover:bg-emerald-700 text-white p-3 rounded-full transform -translate-y-1/2 transition-transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-gray-900"
            ...
            <ul className="space-y-2">
              {[
                ...
                >
                  <Link
                    href={link.href}
                    className="text-gray-400 hover:text-white transition-colors inline-block py-1 border-b border-transparent hover:border-emerald-500"
                  >
                    {link.name}
                  </Link>
                </motion.li>
