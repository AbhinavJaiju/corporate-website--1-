    ...
    <section ref={ref} className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-20 text-center">
        <motion.div style={{ y: textY, opacity }} className="flex flex-col items-center">
          ...
          >
            Building Tomorrow's <span className="text-emerald-400">Solutions</span>
          </motion.h1>
          ...
          >
            <Button asChild size="lg" className="bg-emerald-600 hover:bg-emerald-700 group shadow-lg">
              <Link href="/about">
                Discover Our Vision
                <motion.span
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-white text-white hover:bg-white/10 backdrop-blur-sm shadow-lg"
            >
